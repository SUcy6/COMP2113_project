...
- There is a scoreboard:clipboard::bar_chart: showing username, best score and current score
...
6. `Multiple files` are used for codes regarding different aspects, such as creating the grid, reading the input, random tetrinoes generator, score calculator, etc.
7. The steady falling of tiles are achieved by `Qtimer`.
